...
<div class=" bg-zinc-100 h-screen w-screen fixed" x-data="{ showModal: false, email: '' }">
    ...
    <div class="grid grid-cols-5 gap-5 mt-1 p-4 ml-8 ">
...
<div class="bg-white w-3/4 p-4 rounded-md ml-12 h-[350px] shadow-xl" >
    <div class=" items-center justify-center min-h-[450px] mt-3">
